...
api_instance = giteaclient.AdminApi(giteaclient.ApiClient(configuration))
...
# create an instance of the API class
api_instance = giteaclient.AdminApi(giteaclient.ApiClient(configuration))
body = giteaclient.CreateRepoOption() # CreateRepoOption | 
...
# create an instance of the API class
api_instance = giteaclient.AdminApi(giteaclient.ApiClient(configuration))
body = giteaclient.CreateUserOption() # CreateUserOption |  (optional)
...
body = giteaclient.EditUserOption() # EditUserOption |  (optional)
