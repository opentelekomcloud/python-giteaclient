...
api_instance = giteaclient.MiscellaneousApi(giteaclient.ApiClient(configuration))
...
# create an instance of the API class
api_instance = giteaclient.MiscellaneousApi(giteaclient.ApiClient(configuration))
body = giteaclient.MarkdownOption() # MarkdownOption |  (optional)
